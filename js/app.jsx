            ...
            {page === 'investors' && (
              <div className="zsw-wrap" style={{ padding: '120px 64px', textAlign: 'left' }}>
                ...
                <div style={{ display: 'flex', gap: 14, marginTop: 32 }}>
                  <button className="zsw-btn primary lg" onClick={() => setPage('home')}>Primary action <span className="arr">→</span></button>
                  <button className="zsw-btn secondary lg" onClick={() => setPage('home')}>Secondary action <span className="arr">→</span></button>
                </div>
              </div>
            )}
          </main>
